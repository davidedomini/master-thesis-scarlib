...
The \emph{interaction} among the various components depends on the selected \emph{training and execution model}. 
    The framework provides two pre-implemented models: \texttt{CTDESystem} and \texttt{DTDESystem}. 
    ...
    \Cref{fig:dtde-sequence}. In general, the main interaction takes place between the agents and the environment, in both models: 
