...
Both approaches have their pros and cons. This thesis proposes a \emph{hybrid approach} that maximises 
    their potential by utilising aggregate computing to manage infrastructure-related aspects, like leader election, 
    and reinforcement learning for acquiring complex behaviours that would be difficult to accomplish in a solely 
    programmatic way.
...
The first two chapters aim to present a broad scope of the objectives, motivations, and theoretical concepts that serve as the foundation 
    of this thesis. Subsequently, the project that has been developed is presented, starting with the requirements and domain analysis and 
    then delving into the design, implementation, and development process management choices. 
    Finally, two experiments carried out to validate the functionalities of the framework are presented, followed by the limitations 
